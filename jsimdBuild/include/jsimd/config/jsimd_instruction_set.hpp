...
#define JSIMD_ARM7_NEON_VERSION JSIMD_VERSION_NUMBER(7, 0, 0)
#define JSIMD_ARM8_32_NEON_VERSION JSIMD_VERSION_NUMBER(8, 0, 0)
#define JSIMD_ARM8_64_NEON_VERSION JSIMD_VERSION_NUMBER(8, 1, 0)
