#ifndef JSIMD_AVX_INT64_HPP
#define JSIMD_AVX_INT64_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(int64_t, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(int64_t, 4)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(uint64_t, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint64_t, 4)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE_INT64(int64_t, 4, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(int64_t, 4, 32)

    /*************************************
     * batch<uint64_t, 4> implementation *
     *************************************/

    JSIMD_DEFINE_LOAD_STORE_INT64(uint64_t, 4, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint64_t, 4, 32)
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_add_epi64, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_sub_epi64, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpeq_epi64, lhs, rhs);
#endif
            }
...
#elif JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpgt_epi64, rhs, lhs);
#endif
            }
