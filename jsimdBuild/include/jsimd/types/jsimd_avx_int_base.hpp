#ifndef JSIMD_AVX_INT_BASE_HPP
#define JSIMD_AVX_INT_BASE_HPP
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_and_si128, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_or_si128, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_xor_si128, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_andnot_si128, lhs, rhs);
#endif
            }
