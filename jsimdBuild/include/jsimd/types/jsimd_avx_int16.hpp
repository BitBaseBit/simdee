#ifndef JSIMD_AVX_INT16_HPP
#define JSIMD_AVX_INT16_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(int16_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(int16_t, 16)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(uint16_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint16_t, 16)
    };
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_add_epi16, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_sub_epi16, lhs, rhs);
#endif
            }
...
// #if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpeq_epi16, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpgt_epi16, rhs, lhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_min_epi16, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_max_epi16, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_min_epu16, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_max_epu16, lhs, rhs);
#endif
            }
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(int16_t, 16, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(int16_t, 16, 32)
    ...
    {
#if defined(JSIMD_AVX512VL_AVAILABLE) && defined(JSIMD_AVX512BW_AVAILABLE)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(uint16_t, 16, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint16_t, 16, 32)
