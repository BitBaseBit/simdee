#ifndef JSIMD_AVX512_DOUBLE_HPP
#define JSIMD_AVX512_DOUBLE_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(double, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(double, 8)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 8, bool, 64)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 8, int64_t, 64)
    JSIMD_DEFINE_LOAD_STORE(double, 8, uint64_t, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(double, 8, 64)
    ...
    namespace detail
    {
        ...
        struct batch_kernel<double, 8>
        {
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<double, 4>(res1));
            }
