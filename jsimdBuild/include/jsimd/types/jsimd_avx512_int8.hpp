#ifndef JSIMD_AVX512_INT8_HPP
#define JSIMD_AVX512_INT8_HPP
...
#define JSIMD_APPLY_AVX2_FUNCTION_INT8(func, avx_lhs, avx_rhs) \
    JSIMD_APPLY_AVX2_FUNCTION(32, func, avx_lhs, avx_rhs)
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(int8_t, 64)
        JSIMD_DECLARE_LOAD_STORE_LONG(int8_t, 64)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(uint8_t, 64)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint8_t, 64)
    };
    ...
    namespace detail
    {
        ...
        struct avx512_int8_batch_kernel
        {
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(add, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(sub, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(mul, lhs, rhs);
            #endif
            }

            static batch_type div(const batch_type& lhs, const batch_type& rhs)
            {
                JSIMD_APPLY_AVX2_FUNCTION_INT8(div, lhs, rhs);
            }
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<value_type, 32>(tmp));
            }
            ...
            : public avx512_int8_batch_kernel<int8_t>
        {
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(min, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(max, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(eq, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(neq, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(lt, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT8(lte, lhs, rhs);
            #endif
            }
        };
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(int8_t, 64, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(int8_t, 64, 64)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(uint8_t, 64, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint8_t, 64, 64)

#undef JSIMD_APPLY_AVX2_FUNCTION_INT8
}
