#ifndef JSIMD_AVX512_FLOAT_HPP
#define JSIMD_AVX512_FLOAT_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(float, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(float, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(float, 16, bool, 64)
    ...
    JSIMD_DEFINE_LOAD_STORE(float, 16, int64_t, 64)
    JSIMD_DEFINE_LOAD_STORE(float, 16, uint64_t, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(float, 16, 64)
    ...
    namespace detail
    {
        ...
        struct batch_kernel<float, 16>
        {
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<float, 8>(res1));
            }
            ...
            static batch_type haddp(const batch_type* row)
            {
                ...
                // tmp1 = [a0..8, b0..8]
                // tmp2 = [a8..f, b8..f]
#define JSIMD_AVX512_HADDP_STEP1(I, a, b)                                                  \
        ...
        {                                                                                      \
            ...
            res ## I = tmp1 + tmp2;                                                            \
                ...
                JSIMD_AVX512_HADDP_STEP1(0, row[0], row[2]);
                JSIMD_AVX512_HADDP_STEP1(1, row[4], row[6]);
                JSIMD_AVX512_HADDP_STEP1(2, row[1], row[3]);
                JSIMD_AVX512_HADDP_STEP1(3, row[5], row[7]);
                JSIMD_AVX512_HADDP_STEP1(4, row[8], row[10]);
                JSIMD_AVX512_HADDP_STEP1(5, row[12], row[14]);
                JSIMD_AVX512_HADDP_STEP1(6, row[9], row[11]);
                JSIMD_AVX512_HADDP_STEP1(7, row[13], row[15]);

#undef JSIMD_AVX512_HADDP_STEP1
...
#define JSIMD_AVX512_HADDP_STEP2(I, a, b, c, d)                                             \
        ...
        {                                                                                       \
            ...
            halfx ## I  = _mm256_hadd_ps(_mm512_extractf32x8_ps(resx3, 0),                      \
                ...
                JSIMD_AVX512_HADDP_STEP2(0, res0, res1, res2, res3);
                JSIMD_AVX512_HADDP_STEP2(1, res4, res5, res6, res7);

#undef JSIMD_AVX512_HADDP_STEP2
