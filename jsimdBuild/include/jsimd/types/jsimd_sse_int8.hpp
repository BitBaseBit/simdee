#ifndef JSIMD_SSE_INT8_HPP
#define JSIMD_SSE_INT8_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(int8_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(int8_t, 16)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(uint8_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint8_t, 16)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(int8_t, 16, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(int8_t, 16, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(uint8_t, 16, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint8_t, 16, 16)
