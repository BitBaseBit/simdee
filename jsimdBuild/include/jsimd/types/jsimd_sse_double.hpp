#ifndef JSIMD_SSE_DOUBLE_HPP
#define JSIMD_SSE_DOUBLE_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(double, 2)
        JSIMD_DECLARE_LOAD_STORE_LONG(double, 2)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 2, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 2, int32_t, 16)
    JSIMD_DEFINE_LOAD_STORE(double, 2, uint32_t, 16)
    JSIMD_DEFINE_LOAD_STORE(double, 2, int64_t, 16)
    JSIMD_DEFINE_LOAD_STORE(double, 2, uint64_t, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(double, 2, 16)
    JSIMD_DEFINE_LOAD_STORE(double, 2, float, 16)
    ...
    namespace detail
    {
        ...
        struct batch_kernel<double, 2>
        {
            ...
            {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_SSE3_VERSION
