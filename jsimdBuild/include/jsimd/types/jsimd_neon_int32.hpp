#ifndef JSIMD_NEON_INT32_HPP
#define JSIMD_NEON_INT32_HPP

#include <utility>

#include "jsimd_base.hpp"
#include "jsimd_neon_bool.hpp"
#include "jsimd_neon_utils.hpp"
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(int32_t, 4)
    ...
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, bool, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, int8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, uint8_t, JSIMD_DEFAULT_ALIGNMENT)
    ...
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, int64_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, uint64_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE_LONG(int32_t, 4, 64)
