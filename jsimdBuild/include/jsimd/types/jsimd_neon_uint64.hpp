#ifndef JSIMD_NEON_UINT64_HPP
#define JSIMD_NEON_UINT64_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(uint64_t, 2)
    ...
    *************************************/
    ...
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, bool, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, int8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, uint8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, int16_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, uint16_t, JSIMD_DEFAULT_ALIGNMENT)
    ...
    namespace detail
    {
        ...
        struct batch_kernel<uint64_t, 2>
        {
            ...
            {
#if JSIMD_ARM_INSTR_SET >= JSIMD_ARM8_64_NEON_VERSION && defined(JSIMD_FAST_INTEGER_DIVISION)
