#ifndef JSIMD_SSE_INT32_HPP
#define JSIMD_SSE_INT32_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(int32_t, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(int32_t, 4)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(uint32_t, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint32_t, 4)
    };
...
#define SSE_DEFINE_LOAD_STORE_INT32(TYPE, CVT_TYPE)                            \
    ...
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE_LONG(int32_t, 4, 16)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, int64_t, 16)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 4, uint64_t, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE_LONG(uint32_t, 4, 16)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, int64_t, 16)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, uint64_t, 16)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, float, 16)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, double, 16)
...
#undef SSE_DEFINE_LOAD_STORE_INT32
    ...
    namespace detail
    {
            ...
            : sse_int_kernel_base<batch<T, 4>>
        {
            ...
            {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_SSSE3_VERSION
