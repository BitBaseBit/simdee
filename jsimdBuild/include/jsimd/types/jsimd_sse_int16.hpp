#ifndef JSIMD_SSE_INT16_HPP
#define JSIMD_SSE_INT16_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(int16_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(int16_t, 8)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(uint16_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint16_t, 8)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(int16_t, 8, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(int16_t, 8, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(uint16_t, 8, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint16_t, 8, 16)
