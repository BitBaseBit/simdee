...
namespace jsimd
{
    namespace detail
    {
        ...
        __m256i jsimd_cvtepi8_epi32(__m128i a);
        __m256i jsimd_cvtepu8_epi32(__m128i a);

        // Returns an vector containing 8 int8 in its low half
        __m128i jsimd_cvtepi32_epi8(__m256i a);
        __m128i jsimd_cvtepi32_epu8(__m256i a);

        // a contains 16 int8
        __m256i jsimd_cvtepi16_epi32(__m128i a);
        __m256i jsimd_cvtepu16_epi32(__m128i a);

        // Returns an vector containing 8 int16
        __m128i jsimd_cvtepi32_epi16(__m256i a);
        __m128i jsimd_cvtepi32_epu16(__m256i a);

        /******************
         * Implementation *
         ******************/

        inline __m256i jsimd_cvtepi8_epi32(__m128i a)
        {
        ...
        inline __m256i jsimd_cvtepu8_epi32(__m128i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
        ...
        inline __m128i jsimd_cvtepi32_epi8(__m256i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
        ...
        inline __m128i jsimd_cvtepi32_epu8(__m256i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
            __m256i tmp2 = _mm256_packs_epi32(a, a);
            __m256i tmp3 = _mm256_permute4x64_epi64(tmp2, _MM_SHUFFLE(3, 1, 2, 0));
        ...
        inline __m256i jsimd_cvtepi16_epi32(__m128i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
        ...
        inline __m256i jsimd_cvtepu16_epi32(__m128i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
        ...
        inline __m128i jsimd_cvtepi32_epi16(__m256i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
        ...
        inline __m128i jsimd_cvtepi32_epu16(__m256i a)
        {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_AVX2_VERSION
