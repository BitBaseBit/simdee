...
JVec_inline simd4f simd4f_sum(simd4f v) { 
...
JVec_inline simd4f simd4f_dot4(simd4f lhs, simd4f rhs) {
    return simd4f_sum( simd4f_mul(lhs, rhs) );
}

JVec_inline simd4f simd4f_dot2(simd4f lhs, simd4f rhs) {
...
JVec_inline simd4f simd4f_length4(simd4f v) {
    return simd4f_sqrt( simd4f_dot4(v,v) );
}

JVec_inline simd4f simd4f_length3(simd4f v) {
    return simd4f_sqrt( simd4f_dot3(v,v) );
}

JVec_inline simd4f simd4f_length2(simd4f v) {
    return simd4f_sqrt( simd4f_dot2(v,v) );
}

JVec_inline simd4f simd4f_length4_squared(simd4f v) {
    return simd4f_dot4(v,v);
}

JVec_inline simd4f simd4f_length3_squared(simd4f v) {
    return simd4f_dot3(v,v);
}

JVec_inline float simd4f_length3_squared_scalar(simd4f v) {
    return simd4f_dot3_scalar(v,v);
}

JVec_inline simd4f simd4f_length2_squared(simd4f v) {
    return simd4f_dot2(v,v);
}


JVec_inline simd4f simd4f_normalize4(simd4f a) {
    simd4f invlen = simd4f_rsqrt( simd4f_dot4(a,a) );
    return simd4f_mul(a, invlen);    
}

JVec_inline simd4f simd4f_normalize3(simd4f a) {
    simd4f invlen = simd4f_rsqrt( simd4f_dot3(a,a) );
    return simd4f_mul(a, invlen);
}

JVec_inline simd4f simd4f_normalize2(simd4f a) {
