...
#define JSIMD_REPEAT_8_0(op, addx)    \
...
#define JSIMD_REPEAT_8_N(op, addx)    \
    CASE(EXPAND(op), 0 + addx);       \
    JSIMD_REPEAT_8_0(op, addx);

#define JSIMD_REPEAT_8(op)            \
    JSIMD_REPEAT_8_0(op, 0);

#define JSIMD_REPEAT_16_0(op, addx)   \
    JSIMD_REPEAT_8_0(op, 0 + addx);   \
    JSIMD_REPEAT_8_N(op, 8 + addx);

#define JSIMD_REPEAT_16_N(op, addx)   \
    JSIMD_REPEAT_8_N(op, 0 + addx);   \
    JSIMD_REPEAT_8_N(op, 8 + addx);

#define JSIMD_REPEAT_16(op)           \
    JSIMD_REPEAT_16_0(op, 0);

#define JSIMD_REPEAT_32_0(op, addx)   \
    JSIMD_REPEAT_16_0(op, 0 + addx);  \
    JSIMD_REPEAT_16_N(op, 16 + addx);

#define JSIMD_REPEAT_32_N(op, addx)   \
    JSIMD_REPEAT_16_N(op, 0 + addx);  \
    JSIMD_REPEAT_16_N(op, 16 + addx);

#define JSIMD_REPEAT_32(op)           \
    JSIMD_REPEAT_32_0(op, 0);

#define JSIMD_REPEAT_64(op)           \
    JSIMD_REPEAT_32_0(op, 0);         \
    JSIMD_REPEAT_32_N(op, 32);
