...
namespace jsimd
{
    ...
    /*******************************************
     * jsimd_complex_batch_bool implementation *
     *******************************************/
    ...
    namespace detail
    {
        ...
        struct batch_bool_complex_kernel
        {
            ...
            {
                return jsimd::bitwise_andnot(lhs.value(), rhs.value());
            }
            ...
            {
                return jsimd::all(rhs.value());
            }

            static bool any(const batch_type& rhs)
            {
                return jsimd::any(rhs.value());
            }
        };
    ...
    /**************************************
     * jsimd_complex_batch implementation *
     **************************************/
