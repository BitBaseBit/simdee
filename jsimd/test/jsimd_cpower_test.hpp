#ifndef JSIMD_CPOWER_TEST_HPP
#define JSIMD_CPOWER_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_cpower(std::ostream& out, T& tester)
    {
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::pow(tester.lhs_np[0], tester.rhs[0]), tester.pow_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::sqrt(tester.lhs_nn[0]), tester.sqrt_nn_res[0], out);
