#ifndef JSIMD_FP_MANIPULATION_TEST_HPP
#define JSIMD_FP_MANIPULATION_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_fp_manipulation(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::ldexp(tester.input[0], tester.exponent), tester.ldexp_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::frexp(tester.input[0], tester.exponent), tester.frexp_res[0], out);
