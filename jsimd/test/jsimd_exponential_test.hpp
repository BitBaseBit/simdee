#ifndef JSIMD_EXPONENTIAL_TEST_HPP
#define JSIMD_EXPONENTIAL_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_exponential(std::ostream& out, T& tester)
    {
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::exp2(tester.exp_input[0]), tester.exp2_res[0], out);
