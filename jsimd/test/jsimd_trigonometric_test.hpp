#ifndef JSIMD_TRIGONOMETRIC_TEST_HPP
#define JSIMD_TRIGONOMETRIC_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_trigonometric(std::ostream& out, T& tester)
    {
        ...
        success = success && tmp_success;
        (void)jsimd::sincos(tester.input[0], res[0], res2[0]);
        ...
        (void)jsimd::asin(tester.input[0]);
        ...
        (void)jsimd::acos(tester.input[0]);
        ...
        (void)jsimd::atan(tester.input[0]);
        ...
        (void)jsimd::atan2(tester.atan2_lhs, tester.input[0]);
