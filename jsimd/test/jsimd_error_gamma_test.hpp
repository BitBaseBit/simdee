#ifndef JSIMD_ERROR_GAMMA_TEST_HPP
#define JSIMD_ERROR_GAMMA_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_error_gamma(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::erf(tester.input[0]), tester.erf_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::erfc(tester.input[0]), tester.erfc_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::tgamma(tester.gamma_input[0]), tester.tgamma_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::tgamma(tester.gamma_neg_input[0]), tester.tgamma_neg_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::lgamma(tester.gamma_input[0]), tester.lgamma_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::lgamma(tester.gamma_neg_input[0]), tester.lgamma_neg_res[0], out);
#endif
        return success;
    }
}
