#ifndef JSIMD_CTRIGONOMETRIC_TEST_HPP
#define JSIMD_CTRIGONOMETRIC_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_ctrigonometric(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::sin(tester.input[0]), tester.sin_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::cos(tester.input[0]), tester.cos_res[0], out);
        ...
        jsimd::sincos(tester.input[0], res[0], res2[0]);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::tan(tester.input[0]), tester.tan_res[0], out);
        ...
        success &= check_almost_equal(topic, jsimd::asin(tester.ainput[0]), tester.asin_res[0], out);
        ...
        success &= check_almost_equal(topic, jsimd::acos(tester.ainput[0]), tester.acos_res[0], out);
        ...
        success &= check_almost_equal(topic, jsimd::atan(tester.atan_input[0]), tester.atan_res[0], out);
