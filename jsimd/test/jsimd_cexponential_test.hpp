#ifndef JSIMD_CEXPONENTIAL_TESTER_HPP
#define JSIMD_CEXPONENTIAL_TESTER_HPP

#include "jsimd_test_utils.hpp"
#include "jsimd_complex_tester.hpp"
...
namespace jsimd
{
    ...
    bool test_simd_cexponential(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::exp(tester.exp_input[0]), tester.exp_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::expm1(tester.exp_input[0]), tester.expm1_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::exp(tester.huge_exp_input[0]), tester.huge_exp_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::log(tester.log_input[0]), tester.log_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::log2(tester.log_input[0]), tester.log2_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::log10(tester.log_input[0]), tester.log10_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::log1p(tester.log_input[0]), tester.log1p_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::sign(tester.exp_input[0]), tester.sign_res[0], out);
        return success;
    }
}
