#ifndef JSIMD_ROUNDING_TEST_HPP
#define JSIMD_ROUNDING_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_rounding(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::ceil(tester.input[0]), tester.ceil_res[0], out);
        ...
        success = success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::floor(tester.input[0]), tester.floor_res[0], out);
        ...
        success = success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::trunc(tester.input[0]), tester.trunc_res[0], out);
        ...
        success = success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::round(tester.input[0]), tester.round_res[0], out);
        ...
        success = success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::nearbyint(tester.input[0]), tester.nearbyint_res[0], out);
        ...
        success = success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::rint(tester.input[0]), tester.rint_res[0], out);
