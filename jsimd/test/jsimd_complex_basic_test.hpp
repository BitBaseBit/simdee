#ifndef JSIMD_COMPLEX_BASIC_TEST_HPP
#define JSIMD_COMPLEX_BASIC_TEST_HPP

#include "jsimd_test_utils.hpp"
#include "jsimd_complex_tester.hpp"

#include "jsimd/math/jsimd_math_complex.hpp"
#include "jsimd/types/jsimd_traits.hpp"
...
namespace jsimd
{
    ...
    bool test_simd_complex_basic(std::ostream& out, T& tester)
    {
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::norm(tester.lhs[0]), tester.norm_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::proj(tester.lhs[0]), tester.proj_res[0], out);
