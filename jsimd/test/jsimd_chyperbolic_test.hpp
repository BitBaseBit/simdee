#ifndef JSIMD_CHYPERBOLIC_TEST_HPP
#define JSIMD_CHYPERBOLIC_TEST_HPP
...
namespace jsimd
{
    ...
    bool test_simd_chyperbolic(std::ostream& out, T& tester)
    {
        ...
        success &= check_almost_equal(topic, jsimd::sinh(tester.input[0]), tester.sinh_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::cosh(tester.input[0]), tester.cosh_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::tanh(tester.input[0]), tester.tanh_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::asinh(tester.input[0]), tester.asinh_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::acosh(tester.acosh_input[0]), tester.acosh_res[0], out);
        ...
        success = success && tmp_success;
        success &= check_almost_equal(topic, jsimd::atanh(tester.atanh_input[0]), tester.atanh_res[0], out);
