#ifndef JSIMD_AVX_DOUBLE_HPP
#define JSIMD_AVX_DOUBLE_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(double, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(double, 4)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 4, bool, 32)
    ...
    JSIMD_DEFINE_LOAD_STORE(double, 4, uint32_t, 32)
    JSIMD_DEFINE_LOAD_STORE(double, 4, int64_t, 32)
    JSIMD_DEFINE_LOAD_STORE(double, 4, uint64_t, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(double, 4, 32)
