#ifndef JSIMD_SSE_FLOAT_HPP
#define JSIMD_SSE_FLOAT_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(float, 4)
        JSIMD_DECLARE_LOAD_STORE_LONG(float, 4)
    ...
    JSIMD_DEFINE_LOAD_STORE(float, 4, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(float, 4, uint32_t, 16)
    JSIMD_DEFINE_LOAD_STORE(float, 4, int64_t, 16)
    JSIMD_DEFINE_LOAD_STORE(float, 4, uint64_t, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(float, 4, 16)
