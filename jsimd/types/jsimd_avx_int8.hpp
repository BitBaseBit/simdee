#ifndef JSIMD_AVX_INT8_HPP
#define JSIMD_AVX_INT8_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(int8_t, 32)
        JSIMD_DECLARE_LOAD_STORE_LONG(int8_t, 32)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT8(uint8_t, 32)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint8_t, 32)
    };
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_add_epi8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_sub_epi8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpeq_epi8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpgt_epi8, rhs, lhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_min_epi8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_max_epi8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_min_epu8, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_max_epu8, lhs, rhs);
#endif
            }
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(int8_t, 32, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(int8_t, 32, 32)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT8(uint8_t, 32, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint8_t, 32, 32)
}
