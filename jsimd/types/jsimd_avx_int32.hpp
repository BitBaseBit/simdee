#ifndef JSIMD_AVX_INT32_HPP
#define JSIMD_AVX_INT32_HPP

#include <cstdint>

#include "jsimd_base.hpp"
#include "jsimd_avx_int_base.hpp"
#include "jsimd_int_conversion.hpp"
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(int32_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(int32_t, 8)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(uint32_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint32_t, 8)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, bool, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, int8_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, uint8_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, int16_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, uint16_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, int64_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, uint64_t, 32)
    JSIMD_DEFINE_LOAD_STORE(int32_t, 8, double, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(int32_t, 8, 32)

    /*************************************
     * batch<uint32_t, 8> implementation *
     *************************************/

    JSIMD_DEFINE_LOAD_STORE_INT32(uint32_t, 8, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint32_t, 8, 32)
    ...
    namespace detail
    {
            ...
            : avx_int_kernel_base<batch<int32_t, 8>>
        {
            ...
            static batch_type neg(const batch_type& rhs)
            {
                ...
                JSIMD_RETURN_MERGED_SSE(res_low, res_high);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_add_epi32, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_sub_epi32, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_mullo_epi32, lhs, rhs);
#endif
            }

            static batch_type div(const batch_type& lhs, const batch_type& rhs)
            {
#if defined(JSIMD_FAST_INTEGER_DIVISION)
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpeq_epi32, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_cmpgt_epi32, rhs, lhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_min_epi32, lhs, rhs);
#endif
            }
...
#else
                JSIMD_APPLY_SSE_FUNCTION(_mm_max_epi32, lhs, rhs);
#endif
            }
