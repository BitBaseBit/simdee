#ifndef JSIMD_AVX512_INT64_HPP
#define JSIMD_AVX512_INT64_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(int64_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(int64_t, 8)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(uint64_t, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint64_t, 8)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, bool, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, int8_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, uint8_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, int16_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, uint16_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, int32_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, uint32_t, 64)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 8, float, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(int64_t, 8, 64)
    ...
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, bool, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, int8_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, uint8_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, int16_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, uint16_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, int32_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, uint32_t, 64)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 8, float, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint64_t, 8, 64)
    ...
    namespace detail
    {
        ...
        struct avx512_int64_batch_kernel
        {
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<int64_t, 4>(res1));
            }
