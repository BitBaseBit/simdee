#ifndef JSIMD_AVX512_INT16_HPP
#define JSIMD_AVX512_INT16_HPP

#include "jsimd_avx512_bool.hpp"
#include "jsimd_avx512_int_base.hpp"

namespace jsimd
{

#define JSIMD_APPLY_AVX2_FUNCTION_INT16(func, avx_lhs, avx_rhs) \
    JSIMD_APPLY_AVX2_FUNCTION(16, func, avx_lhs, avx_rhs)
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(int16_t, 32)
        JSIMD_DECLARE_LOAD_STORE_LONG(int16_t, 32)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT16(uint16_t, 32)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint16_t, 32)
    };
    ...
    namespace detail
    {
        ...
        struct avx512_int16_batch_kernel
        {
            ...
            static batch_type neg(const batch_type& rhs)
            {
                ...
                JSIMD_RETURN_MERGED_AVX(res_low, res_high);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(add, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(sub, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(mul, lhs, rhs);
            #endif
            }

            static batch_type div(const batch_type& lhs, const batch_type& rhs)
            {
                JSIMD_APPLY_AVX2_FUNCTION_INT16(div, lhs, rhs);
            }

            static batch_type mod(const batch_type& lhs, const batch_type& rhs)
            {
                JSIMD_MACRO_UNROLL_BINARY(%);
            }
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<value_type, 16>(tmp));
            }
            ...
            static batch_type select(const batch_bool_type& cond, const batch_type& a, const batch_type& b)
            {
                ...
                // See https://github.com/xtensor-stack/jsimd/issues/315
                __m512i ma = a;
                __m512i mb = b;
                return _mm512_mask_blend_epi16(cond, mb, ma);
            #else
                JSIMD_SPLIT_AVX512(cond);
                JSIMD_SPLIT_AVX512(a);
                JSIMD_SPLIT_AVX512(b);

                auto res_lo = _mm256_blendv_epi8(b_low, a_low, cond_low);
                auto res_hi = _mm256_blendv_epi8(b_high, a_high, cond_high);

                JSIMD_RETURN_MERGED_AVX(res_lo, res_hi);
            #endif
            }
        };
            ...
            : public avx512_int16_batch_kernel<int16_t>
        {
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(min, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(max, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(eq, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(neq, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(lt, lhs, rhs);
            #endif
            }
            ...
            #else
                JSIMD_APPLY_AVX2_FUNCTION_INT16(lte, lhs, rhs);
            #endif
            }
        };
    ...
    {
#if defined(JSIMD_AVX512BW_AVAILABLE)
#if defined(JSIMD_AVX512_SHIFT_INTRINSICS_IMM_ONLY)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(int16_t, 32, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(int16_t, 32, 64)
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(uint16_t, 32, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint16_t, 32, 64)

#undef JSIMD_APPLY_AVX2_FUNCTION_INT16
}
