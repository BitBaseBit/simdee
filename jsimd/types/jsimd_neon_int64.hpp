...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(int64_t, 2)
    ...
    ************************************/
    ...
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, bool, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, int8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, uint8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, int16_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, uint16_t, JSIMD_DEFAULT_ALIGNMENT)
