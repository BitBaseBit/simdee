...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(uint32_t, 4)
    ...
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, bool, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, int8_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, uint8_t, JSIMD_DEFAULT_ALIGNMENT)
    ...
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, int64_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE(uint32_t, 4, uint64_t, JSIMD_DEFAULT_ALIGNMENT)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint32_t, 4, 64)
