#ifndef JSIMD_SSE_INT64_HPP
#define JSIMD_SSE_INT64_HPP

#include <cstdint>

#include "jsimd_base.hpp"
#include "jsimd_sse_int_base.hpp"
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(int64_t, 2)
        JSIMD_DECLARE_LOAD_STORE_LONG(int64_t, 2)
   };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT64(uint64_t, 2)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint64_t, 2)
    };
...
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_SSE4_1_VERSION
...
#define SSE_DEFINE_LOAD_STORE_INT64(TYPE, CVT_TYPE)                            \
    ...
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, int32_t, 16)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, uint32_t, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(int64_t, 2, 16)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, float, 16)
    JSIMD_DEFINE_LOAD_STORE(int64_t, 2, double, 16)

    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, bool, 16)
    ...
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, int32_t, 16)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, uint32_t, 16)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint64_t, 2, 16)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, float, 16)
    JSIMD_DEFINE_LOAD_STORE(uint64_t, 2, double, 16)
...
#undef SSE_DEFINE_LOAD_STORE_INT64
    ...
    namespace detail
    {
            ...
            : sse_int64_batch_kernel<int64_t>
        {
            ...
            {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_SSE4_2_VERSION
