#ifndef JSIMD_NEON_UINT16_HPP
#define JSIMD_NEON_UINT16_HPP
...
namespace jsimd
{
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(uint16_t, 8, 8)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint16_t, 8, 8)
