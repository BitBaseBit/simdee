#ifndef JSIMD_AVX_FLOAT_HPP
#define JSIMD_AVX_FLOAT_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_ALL(float, 8)
        JSIMD_DECLARE_LOAD_STORE_LONG(float, 8)
    ...
    {
        __m128i tmp = _mm_loadl_epi64((const __m128i*)src);
        __m256i tmp2 = detail::jsimd_cvtepu8_epi32(tmp);
        this->m_value = _mm256_cvtepi32_ps(tmp2);
        return *this;
    }
    ...
    inline batch<float, 8>& batch<float, 8>::load_aligned(const int16_t* src)
    {
        ...
        __m256i tmp2 = detail::jsimd_cvtepi16_epi32(tmp);
        this->m_value = _mm256_cvtepi32_ps(tmp2);
        return *this;
    }
    ...
    {
        __m128i tmp = _mm_load_si128((const __m128i*)src);
        __m256i tmp2 = detail::jsimd_cvtepu16_epi32(tmp);
        this->m_value = _mm256_cvtepi32_ps(tmp2);
        return *this;
    }
    ...
    JSIMD_DEFINE_LOAD_STORE(float, 8, uint32_t, 32)
    JSIMD_DEFINE_LOAD_STORE(float, 8, int64_t, 32)
    JSIMD_DEFINE_LOAD_STORE(float, 8, uint64_t, 32)
    JSIMD_DEFINE_LOAD_STORE_LONG(float, 8, 32)
    ...
    inline void batch<float, 8>::store_aligned(int8_t* dst) const
    {
        ...
        __m128i tmp2 = detail::jsimd_cvtepi32_epi8(tmp);
    ...
    {
        __m256i tmp = _mm256_cvtps_epi32(this->m_value);
        __m128i tmp2 = detail::jsimd_cvtepi32_epu8(tmp);
        _mm_storel_epi64((__m128i*)dst, tmp2);
    }
    ...
    {
        __m256i tmp = _mm256_cvtps_epi32(this->m_value);
        __m128i tmp2 = detail::jsimd_cvtepi32_epi16(tmp);
    ...
    {
        __m256i tmp = _mm256_cvtps_epi32(this->m_value);
        __m128i tmp2 = detail::jsimd_cvtepi32_epu16(tmp);
        _mm_store_si128((__m128i*)dst, tmp2);
    }
    ...
    namespace detail
    {
        ...
        struct batch_kernel<float, 8>
        {
            ...
            {
#if JSIMD_X86_INSTR_SET >= JSIMD_X86_FMA3_VERSION
                return _mm256_fmadd_ps(x, y, z);
#elif JSIMD_X86_INSTR_SET >= JSIMD_X86_AMD_FMA4_VERSION
