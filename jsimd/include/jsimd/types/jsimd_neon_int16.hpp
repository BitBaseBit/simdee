#ifndef JSIMD_NEON_INT16_HPP
#define JSIMD_NEON_INT16_HPP
...
namespace jsimd
{
    ...
    JSIMD_DEFINE_LOAD_STORE_INT16(int16_t, 8, 8)
    JSIMD_DEFINE_LOAD_STORE_LONG(int16_t, 8, 8)
