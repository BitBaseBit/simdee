#ifndef JSIMD_AVX512_INT32_HPP
#define JSIMD_AVX512_INT32_HPP
...
namespace jsimd
{
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(int32_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(int32_t, 16)
    };
    ...
    public:
        ...
        JSIMD_DECLARE_LOAD_STORE_INT32(uint32_t, 16)
        JSIMD_DECLARE_LOAD_STORE_LONG(uint32_t, 16)
    };
    ...
    JSIMD_DEFINE_LOAD_STORE_INT32(int32_t, 16, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(int32_t, 16, 64)

    /*************************************
     * batch<uint32_t, 16> implementation *
     *************************************/

    JSIMD_DEFINE_LOAD_STORE_INT32(uint32_t, 16, 64)
    JSIMD_DEFINE_LOAD_STORE_LONG(uint32_t, 16, 64)
    ...
    namespace detail
    {
        ...
        struct avx512_int32_batch_kernel
        {
            ...
            static value_type hadd(const batch_type& rhs)
            {
                ...
                return jsimd::hadd(batch<int32_t, 8>(res1));
            }
