...
#define JSIMD_RETURN_MERGED_AVX(res_low, res_high)                                                    \
    __m512i result = _mm512_castsi256_si512(res_low);                                                 \
    return _mm512_inserti64x4(result, res_high, 1)                                                    \

#define JSIMD_APPLY_AVX2_FUNCTION(N, func, avx_lhs, avx_rhs)                                          \
    JSIMD_SPLIT_AVX512(avx_lhs);                                                                      \
    JSIMD_SPLIT_AVX512(avx_rhs);                                                                      \
