...
JVec_inline simd4f simd4f_zero() { return vdupq_n_f32(0.0f); }
...
JVec_inline simd4f simd4f_rsqrt3(simd4f v) {
    simd4f estimate = vrsqrteq_f32(v);
    simd4f_rsqrt_1iteration(v, estimate);
    simd4f_rsqrt_1iteration(v, estimate);
    simd4f_rsqrt_1iteration(v, estimate);
...
JVec_inline float simd4f_get_x(simd4f s) { return vgetq_lane_f32(s, 0); }
JVec_inline float simd4f_get_y(simd4f s) { return vgetq_lane_f32(s, 1); }
JVec_inline float simd4f_get_z(simd4f s) { return vgetq_lane_f32(s, 2); }
JVec_inline float simd4f_get_w(simd4f s) { return vgetq_lane_f32(s, 3); }
...
JVec_inline simd4f simd4f_shuffle_wxyz(simd4f s) { 
    _simd4f_union u = {s};
    return simd4f_create( u.f[3], u.f[0], u.f[1], u.f[2]); 
}

JVec_inline simd4f simd4f_shuffle_zwxy(simd4f s) { 
    _simd4f_union u = {s};
    return simd4f_create(u.f[2], u.f[3], u.f[0], u.f[1]); 
}

JVec_inline simd4f simd4f_shuffle_yzwx(simd4f s) { 
    _simd4f_union u = {s};
